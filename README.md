...
- Функционал автоматического распознавания текста
- Модель для определения параметров обрезки
- Возможность экспорта в PDF
- Улучшенная визуализация текста в модальном окне
...
- **Text editor** Нумерация регионов идет в порядке распознавания, а хотелось бы сверху-вниз. 